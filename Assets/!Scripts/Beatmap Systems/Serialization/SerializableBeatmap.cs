...
namespace Beatmap.Serialization
{
    ...
    public class SerializableBeatmap        //the crucial data, which is written to disk in whatever form
    {
        ...
        public SerializableBeatmap(IBeatmap beatmap)
        {
    ...
    public class SerializableFrame
    {
        ...
        public SerializableFrame(IFrame frame)
        {
        ...
        public Frame ToFrame(BeatmapType typeInstance)
        {
            ...
            {
                Game.Log(Logging.Category.BEATMAP, "Serializable frame value count and requested type instance channel count mismatch.", Logging.Level.LOG_WARNING);
                return null;
            }
