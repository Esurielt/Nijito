...
namespace Beatmap.Editor
{
    public class UndoStackComponent : EditorComponent
    {
        ...
        public void ExecuteCommand(IUndoableCommand command)
        {
            ...
            command.Execute();
            Game.Log(Logging.Category.BEATMAP, $"Editor command executed: {command.Description}.", Logging.Level.LOG);
        ...
        public void Undo()
        {
            ...
            Game.Log(Logging.Category.BEATMAP, $"Editor command undone: {command.Description}.", Logging.Level.LOG);
        }
        public void Redo()
        {
            ...
            Game.Log(Logging.Category.BEATMAP, $"Editor command redone: {command.Description}.", Logging.Level.LOG);
        }
    }
}