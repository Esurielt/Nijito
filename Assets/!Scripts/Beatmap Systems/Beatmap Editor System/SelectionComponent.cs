...
{
    public class SelectionComponent : EditorComponent
    {
        ...
        private void MoveSelectionEnd(int newFinalVisibleFrame)
        {
            ...
            var newImpliedEnd = newFinalVisibleFrame + (BeatmapUtility.FRAMES_PER_BEAT / subdivisionsPerBeat);
        ...
        {
            var subdivisionsPerBeat = Editor.SubdivisionComponent.CurrentSubdivision.QuantityPerBeat;
            SetSelection(singleSelection, (BeatmapUtility.FRAMES_PER_BEAT / subdivisionsPerBeat));
        }
        ...
        protected override void RepaintInternal()
        {
            var unitWidth = Editor.FrameManagerComponent.GetCurrentFrameWidth() /
                (BeatmapUtility.FRAMES_PER_BEAT / Editor.SubdivisionComponent.CurrentSubdivision.QuantityPerBeat);
