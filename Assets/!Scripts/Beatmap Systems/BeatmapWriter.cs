...
namespace Beatmap
{
    public class BeatmapWriter
    {
        ...
        /// </summary>
        protected int B2F(int beatSizeValue) => BeatmapUtility.ConvertBeatsToFrames(beatSizeValue);
        protected bool FrameExists(int frameIndex) => BeatmapUtility.FrameExists(Beatmap, frameIndex);
        protected bool FramesExist(int startingFrameIndex, int frameCount) => BeatmapUtility.FramesExist(Beatmap, startingFrameIndex, frameCount);
    }
}
